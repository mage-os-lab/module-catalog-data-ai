...
use MageOS\CatalogDataAI\Controller\Adminhtml\Enrichment\MassDelete;
...
class MassDeleteTest extends TestCase
{
    ...
    public function testDeletesEachRecord(): void
    {
    ...
    public function testShowsSuccessCount(): void
    {
        ...
        $this->messageManager
            ...
            ->with($this->callback(function ($msg) {
                $msgStr = (string)$msg;
                return strpos($msgStr, '2') !== false && strpos($msgStr, 'deleted') !== false;
            }));
